(function() {
  ...
  function init() {
    ...
    overlay.style.cssText = 'position:fixed;inset:0;z-index:99999;background:#f6f8fa;display:flex;align-items:center;justify-content:center;font-family:Inter,-apple-system,sans-serif;';
    overlay.innerHTML =
      '<div style="background:#fff;border:1px solid #d0d7de;border-radius:12px;padding:36px 32px;max-width:380px;width:100%;text-align:center;box-shadow:0 8px 32px rgba(0,0,0,0.08);">' +
        ...
        '<input id="gate-pw" type="password" placeholder="Password" autofocus style="width:100%;padding:10px 14px;border:1px solid #d0d7de;border-radius:8px;font-size:14px;font-family:inherit;margin-bottom:12px;outline:none;text-align:center;box-sizing:border-box;" />' +
